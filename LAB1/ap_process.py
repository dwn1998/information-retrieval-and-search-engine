...
docno_ap=[]
text_ap=[]
rootdir1_ap="./disk12/disk1/AP"
rootdir2_ap="./disk12/disk2/AP"
...
if __name__ == '__main__':
    ...
    for word in filename1:
        ...
        g_file.close()
    for parent,dirnames,filenames in os.walk(rootdir2_ap):
        for e in filenames:
            filename2.append(e.replace(".gz",""))
        # filename2.remove('.DS_Store')
    for word in filename2:
        f_name=word
        g_file=gzip.GzipFile(rootdir2_ap+'/'+word+".gz")
        open("./disk_AP/"+f_name,"w+").write(g_file.read().decode())
        g_file.close()
    for parent,dirnames,filenames in os.walk("./disk_AP"):
        for e in filenames:
            filename.append(e)
            ap_getdata("./disk_AP/",e)
            docno_ap=[]
            text_ap=[]
